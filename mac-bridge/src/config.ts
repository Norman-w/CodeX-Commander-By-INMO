...
export type AudioInputSource = "visor" | "mac";
...
const EnvSchema = z.object({
  ...
  COMMANDER_AUDIO_INPUT_SOURCE: z.enum(["visor", "mac"]).default("mac"),
  COMMANDER_LOCAL_AUDIO_OUTPUT: z.enum(["visor_only", "mac_only", "mac_and_visor"]).default("mac_and_visor"),
...
export function loadConfig(env: NodeJS.ProcessEnv = process.env) {
  ...
  return {
    ...
    audio: {
      inputSource: parsed.COMMANDER_AUDIO_INPUT_SOURCE,
